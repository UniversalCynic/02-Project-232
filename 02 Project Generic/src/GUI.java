...
public class GUI extends JFrame implements Cloneable {
	...
	// data collection
	//private List cl;
	private List<Character> cl = new List<Character>();
 ...
 */
	public GUI() {
		...
		sortButton.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				//void selectionSort = cl.<Character>selectionSort(cl.getList(), cl.listSize());
				//selectionSort = cl.selectionSort(cl.getList(), cl.listSize());
				//cl.selectionSort(cl.getList(), cl.listSize());
			}
	...
	public void displayList()	{ 
		...
		Object[] list =  cl.getList();
		for(int i = 0; i < cl.listSize(); i++)	{
			model.addRow(new Object[] {((Character) list[i]).getName(), ((Character) list[i]).getTitle(), ((Character) list[i]).getPrice(), 
				((Character) list[i]).getRole(), ((Character) list[i]).getReleaseDate()});
		}
	}
	...
	public void removeCharacterFromList() {
			cl.delete(nameTextField.getText()); 	//..uh
			nameTextField.setText("");
			titleTextField.setText("");
			priceTextField.setText("");
			roleTextField.setText("");
	...
	public void searchForCharacter() {
		try
		{								// Something is broken ?
		Character character = cl.search(cl.getList(), cl.listSize(), cl.listSize(), nameTextField.getText());
	...
	/*public static void selectionSort(Character[] data, int numItems) {
		 int i ;
		 int j;
		 int big;
		 Character temp; // this is a copy of an array element.
